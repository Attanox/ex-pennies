...
import com.andi.expennies.services.CategoryService;
...
public class CategoryResource {
    ...
    @PostMapping("/")
    public ResponseEntity<Map<String, Boolean>> createCategory(HttpServletRequest request, @RequestBody Map<String, Object> categoryMap) {
        int userId = (Integer) request.getAttribute("userId");
        String title = (String) categoryMap.get("title");
        categoryService.addCategory(userId, title);
    ...
    public ResponseEntity<Map<String, Boolean>> updateCategory(
        ...
        int userId = (Integer) request.getAttribute("userId");
        String title = (String) categoryMap.get("title");
        categoryService.updateCategory(userId, categoryId, title);
        Map<String, Boolean> map = new HashMap<>();
        map.put("success", true);
        return new ResponseEntity<>(map, HttpStatus.OK);
    }
